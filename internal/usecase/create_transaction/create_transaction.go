...
type CreateTransactionInputDTO struct {
	...
	AccountIdDTo  string  `json:"account_id_to"`
...
func (uc *CreateTransactionUseCase) Execute(ctx context.Context, input CreateTransactionInputDTO) (*CreateTransactionOutputDTO, error) {
	...
	err := uc.Uow.Do(context.Background(), func(_ *uow.Uow) error {
		...
		accountTo, err := accountRepository.FindByID(input.AccountIdDTo)
		if err != nil {
			return err
		}
		...
		output.AccountIDTo = input.AccountIdDTo
